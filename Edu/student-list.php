...
<head>
    ...
    <title>Student Management | Dashboard | Edu.lk</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Students Management</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                ...
                <div class="container-fluid">
                            ...
                            <div class="small-box bg-danger">
                                <div class="inner">
                                    <h3>
                                        ...
                                        $query = "SELECT * FROM `users` WHERE `authorize_status` = 'Block' && `user_role` = 'Student'";
                                        $res = mysqli_query($connection, $query);
                                        while ($row = mysqli_fetch_array($res)) {
                                            $total = $total + 1;
                                        }
                        ...
                        <section class="col-lg-12 connectedSortable" id="StudentSubs">
                            ...
                            <div class="card direct-chat direct-chat-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Authorized Students</h3>
                                ...
                                <div class="card-body">
                                    <table id="tabSubs" class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $query = "SELECT * FROM users WHERE user_role = 'Student' && authorize_status = 'Authorized' ORDER BY subscription_date ASC";
                                            $res = mysqli_query($connection, $query);
                                            while ($row = mysqli_fetch_array($res)) {
                                                echo "<tr>";
                                                echo "<td>";
                    ...
                    <div class="row">
                        ...
                        <section class="col-lg-12 connectedSortable" id="InstructorsSubs">
                            ...
                            <div class="card direct-chat direct-chat-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Unauthorized Students</h3>
                                ...
                                <div class="card-body">
                                    <table id="tabSubs" class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $query = "SELECT * FROM users WHERE user_role = 'Student' && authorize_status = 'Block' ORDER BY subscription_date ASC";
                                            $res = mysqli_query($connection, $query);
                                            while ($row = mysqli_fetch_array($res)) {
                                                echo "<tr>";
                                                echo "<td>";
