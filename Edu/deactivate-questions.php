...
<head>
  ...
  <title>Deactivate Questions | Dashboard | Edu.lk</title>
          ...
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="./deactivate-questions.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Disable Questions</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="./index.php">Home</a></li>
                <li class="breadcrumb-item"><a href="./deactivate-questions.php">All Questions</a></li>
                <li class="breadcrumb-item active">Disable Questions</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
        ...
        <div class="container-fluid">
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="card direct-chat direct-chat-primary">
                <div class="card-header">
                  <h3 class="card-title">Questions (Instructors)</h3>
                ...
                <div class="card-body" style="max-height: 1000px; overflow-y: scroll;">
                  <table id="tabIssues" class="table table-hover">
                    <thead>
                      <tr>
                    ...
                    <tbody>
                      ...
                      $query = "SELECT q.qestionId, u.account_name, q.subject, q.time FROM questions q, users u WHERE q.authorId = u.user_id && u.user_role = 'Instructor' && q.status = 'Deactivate' ORDER BY q.time DESC";
                      $res = mysqli_query($connection, $query);
                      while ($row = mysqli_fetch_array($res)) {
                        $Qid = $row["qestionId"];
                        $TotAnswers = 0;
                        $query2 = "SELECT a.answerId FROM questions q, answers a WHERE a.questionId = q.qestionId && q.qestionId = '$Qid'";
                ...
                <div class="card-footer">
                  <form action="./php/EnableQuestion.php" method="post">
                    <div class="input-group">
                      <input type="number" name="qID" id="qID" placeholder="Question ID" class="form-control">
                      <span class="input-group-append">
                        <button type="submit" class="btn btn-primary">Enable Question</button>
                      </span>
                    </div>
                  </form>
                </div>
          ...
          <div class="row">
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="card direct-chat direct-chat-primary">
                <div class="card-header">
                  <h3 class="card-title">Questions (Students)</h3>
                ...
                <div class="card-body" style="max-height: 1000px; overflow-y: scroll;">
                  <table id="tabIssues" class="table table-hover">
                    ...
                    <tbody>
                      ...
                      $query = "SELECT q.qestionId, u.account_name, q.subject, q.time FROM questions q, users u WHERE q.authorId = u.user_id && u.user_role = 'Student' && q.status = 'Deactivate' ORDER BY q.time DESC";
                      $res = mysqli_query($connection, $query);
                      while ($row = mysqli_fetch_array($res)) {
                        $Qid = $row["qestionId"];
                        $TotAnswers = 0;
