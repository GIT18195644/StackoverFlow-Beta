...
<head>
    ...
    <title>Instructors Management | Dashboard | Edu.lk</title>
        ...
        <div class="content-wrapper">
            ...
            <div class="content-header">
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <h1 class="m-0">Instructors Management</h1>
                        </div><!-- /.col -->
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="./index.php">Home</a></li>
                                <li class="breadcrumb-item active">Instructors Management</li>
                            </ol>
                        </div><!-- /.col -->
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                ...
                <div class="container-fluid">
                            ...
                            <div class="small-box bg-danger">
                                <div class="inner">
                                    <h3>
                                        ...
                                        $query = "SELECT * FROM `users` WHERE `authorize_status` = 'Block' && `user_role` = 'Instructor'";
                                        $res = mysqli_query($connection, $query);
                                        while ($row = mysqli_fetch_array($res)) {
                                            $total = $total + 1;
                                        }
                        ...
                        <section class="col-lg-12 connectedSortable" id="StudentSubs">
                            ...
                            <div class="card direct-chat direct-chat-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Authorized Instructors</h3>
                                ...
                                <!-- /.card-header -->
                                <div class="card-body">
                                    <table id="tabSubs" class="table table-hover">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            $query = "SELECT * FROM users WHERE user_role = 'Instructor' && authorize_status = 'Authorized' ORDER BY subscription_date ASC";
                                            $res = mysqli_query($connection, $query);
                                            while ($row = mysqli_fetch_array($res)) {
                                                echo "<tr>";
                                                echo "<td>";
                    ...
                    <div class="row">
                        ...
                        <section class="col-lg-12 connectedSortable" id="InstructorsSubs">
                            ...
                            <div class="card direct-chat direct-chat-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Unauthorized Instructors</h3>
                                ...
                                <div class="card-body">
                                    <table id="tabSubs" class="table table-hover">
                                        ...
                                        <tbody>
                                            ...
                                            $query = "SELECT * FROM users WHERE user_role = 'Instructor' && authorize_status = 'Block' ORDER BY subscription_date ASC";
                                            $res = mysqli_query($connection, $query);
                                            while ($row = mysqli_fetch_array($res)) {
                                                echo "<tr>";
                                                echo "<td>";
