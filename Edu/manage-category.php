               ...
               with font-awesome or any other icon font library -->
                        ...
                        <li class="nav-item">
                            ...
                            <ul class="nav nav-treeview">
                                ...
                                <li class="nav-item">
                                    <a href="./manage-category.php" class="nav-link active">
                                        <i class="far fa-circle nav-icon"></i>
                            ...
                            <div class="row">
                                ...
                                <section class="col-lg-12 connectedSortable">
                                    ...
                                    <div class="card direct-chat direct-chat-primary">
                                        ...
                                        <!-- /.card-header -->
                                        <div class="card-body" style="max-height: 1500px; overflow-y: scroll;">
                                                ...
                                                <div class="card-body" style="padding: 25px;">
                                                    ...
                                                    <form action="./php/EditCategory.php" method="post">
                                                        <div class="row">
                                                            <div class="col">
                                                                <div class="form-group">
                                                                    <label for="CID">Category Code</label>
                                                                    <input type="number" class="form-control" id="CID" name="CID" placeholder="Category Code" required>
                                                                </div>
                                                            </div>
                                                            <div class="col">
                                                                <div class="form-group">
