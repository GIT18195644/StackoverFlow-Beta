                                ...
                                <div class="card-body">
                                    ...
                                    <table id="AllQuestions" class="table table-hover">
                                        <tbody>
                                            ...
                                            $query = "SELECT c.categoryName, q.qestionId, q.subject, q.time, u.account_name FROM questions q, users u, category c WHERE c.cid = q.categoryId && u.user_id = q.authorId && status = 'Activate' ORDER BY q.time DESC";
                                            $res = mysqli_query($connection, $query);
                                            while ($row = mysqli_fetch_array($res)) {
                                                $iid = $row["qestionId"];
                                            ?>
                                                <form action="./question-view.php" method="POST">
                                                    ...
                                                    echo "<tr>";
                                                    echo "<td>";
                                                    echo "<b>" . $row["subject"] . "</b> " . "(" . $row["account_name"] . ")" . " - " . $row["categoryName"];
                                                    echo "</td>";
                                                    echo "<td>";
                                                    echo $row["time"];
                                                    echo "</td>";
