...
<head>
  ...
  <title>Activate Questions | Dashboard | Edu.lk</title>
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                <li class="nav-item">
                  <a href="./activate-questions.php" class="nav-link active">
                    <i class="far fa-circle nav-icon"></i>
    ...
    <div class="content-wrapper">
      ...
      <div class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1 class="m-0">Enable Questions</h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="./index.php">Home</a></li>
                <li class="breadcrumb-item"><a href="./activate-questions.php">All Questions</a></li>
                <li class="breadcrumb-item active">Enable Questions</li>
              </ol>
            </div><!-- /.col -->
          </div><!-- /.row -->
        </div><!-- /.container-fluid -->
            ...
            <section class="col-lg-12 connectedSortable">
              ...
              <div class="card direct-chat direct-chat-primary">
                ...
                <div class="card-body" style="max-height: 1000px; overflow-y: scroll;">
                  <table id="tabIssues" class="table table-hover">
                    ...
                    <tbody>
                      ...
                      $query = "SELECT q.qestionId, u.account_name, q.subject, q.time FROM questions q, users u WHERE q.authorId = u.user_id && u.user_role = 'Instructor' && q.status = 'Activate' ORDER BY q.time DESC";
                      $res = mysqli_query($connection, $query);
                      while ($row = mysqli_fetch_array($res)) {
                        $Qid = $row["qestionId"];
                        $TotAnswers = 0;
                ...
                <div class="card-footer">
                  <form action="./php/DisableQuestion.php" method="post">
                ...
                <div class="card-body" style="max-height: 1000px; overflow-y: scroll;">
                  <table id="tabIssues" class="table table-hover">
                    ...
                    <tbody>
                      ...
                      $query = "SELECT q.qestionId, u.account_name, q.subject, q.time FROM questions q, users u WHERE q.authorId = u.user_id && u.user_role = 'Student' && q.status = 'Activate' ORDER BY q.time DESC";
                      $res = mysqli_query($connection, $query);
                      while ($row = mysqli_fetch_array($res)) {
                        $Qid = $row["qestionId"];
                        $TotAnswers = 0;
